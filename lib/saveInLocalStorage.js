...
window.addEventListener("beforeunload", event => {
  ...
  if (JSON.stringify(saved_paragraphs) !== JSON.stringify(dom_contents)) {
    // on convertit les deux tableaux en string json pour pouvoi les comparer facilement avec l'operateur !==
